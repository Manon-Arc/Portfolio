		...
		<div className="sec-2d">
			<div className="sec-2da">
				...
				<div className="propos-desc">
					<p className="txt">Passionnée par les avancées technologiques, je suis déterminée à faire de ma passion mon métier. Mon parcours académique m'a orientée vers le développement informatique, avec une spécialisation en développement logiciel, mobile et IoT que j'ai approfondie dès ma troisième année de bachelor jusqu'à l'obtention de mon master.</p>
